...
//		printArray(intArr);
		...
		int[] tempArr = doubleArr[0];		// 1, 2, 3
		printArray(tempArr);
		
		tempArr = doubleArr[1];				// 4, 5, 6
		printArray(tempArr);
		
		System.out.println(tempArr[0]);				// 4
		
		System.out.println(doubleArr[1][0]);		// 4
		...
		System.out.println(tripleArr[1][2][0]);		// 16
		System.out.println(tripleArr[2][1][0]);		// 22
		
	} // main
	
	// Stirng 값을 받는 배열 요소 출력 함수
	public static void printArray(String[] strArray) {	// public 공동
		for(int i = 0; i < strArray.length; i++) {
