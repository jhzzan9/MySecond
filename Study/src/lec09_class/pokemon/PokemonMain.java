...
public class PokemonMain {
	public static void main(String[] args) {
		...
		pokemonPool.add(new Pokemon("라이츄", "천만볼트", 75, 300, Constants.TYPE_THUNDER, 75));
		pokemonPool.add(new Pokemon("파이리", "불꽃발사", 50, 200, Constants.TYPE_FIRE, 50));
		pokemonPool.add(new Pokemon("리자드", "할퀴기", 75, 300, Constants.TYPE_FIRE, 75));
		pokemonPool.add(new Pokemon("리자몽", "용의숨결", 100, 400, Constants.TYPE_FIRE, 100));
		pokemonPool.add(new Pokemon("꼬부기", "물대포", 50, 200, Constants.TYPE_WATER, 50));
		pokemonPool.add(new Pokemon("어니부기", "물대포x2", 75, 200, Constants.TYPE_WATER, 75));
		pokemonPool.add(new Pokemon("거북왕", "하이드로펌프", 50, 200, Constants.TYPE_WATER, 50));
		pokemonPool.add(new Pokemon("이상해씨", "덩쿨채찍", 50, 200, Constants.TYPE_PLANT, 50));
		pokemonPool.add(new Pokemon("이상해풀", "씨앗발사", 75, 300, Constants.TYPE_PLANT, 75));
		pokemonPool.add(new Pokemon("이상해꽃", "솔라빔", 100, 400, Constants.TYPE_PLANT, 100));
		...
		// 경매 6번 진행
		for (int i = 0; i < 6; i++) {
			// 0부터 pool 사이즈의 -1 까지 중 랜덤하게 나옵니다.
