...
//		}
		...
		// 1970년 1월 1일 기준으로 해당 millSec 가 지난 날짜로 인식
		strToday = dateFormat.format(1647493927470L);
		System.out.println(strToday);
		...
		// 월(Month)의 경우 1월이 0, 2월이 1, ... 으로 되어 있다.
		cal.set(2021, 2, 17, 12, 30, 21);
		...
		// 새로운 Calendar 객체를 생성한다 ㅎㄷㄷ
		Calendar calTest = Calendar.getInstance();
		// new Date() 처럼 생성될 당시의 시간이 세팅된 캘린더 객체가 생성
...
//		
		...
		// Edit 후 주석 부분 제거.
		// 바로 아래 Constructor body와 Catch block body도 똑같이
