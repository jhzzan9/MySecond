...
public class ApiFormat {
	public static void main(String[] args) {
		...
		String result = MessageFormat.format(formatStr, "jhzzan9", "최지혜", "01043932513");
		System.out.println(result);
		
		formatStr = "ID: %s\n이름: %s\n연락처: %s\n";
		System.out.printf(formatStr, "jhzzan9", "최지혜", "01043932513");
		
		// 두 번째 방식		
		formatStr = "ID: %s\n이름: %s\n연락처: %s\n";
		Object[] arguments = {"jhzzan9", "최지혜", "01043932513"};
