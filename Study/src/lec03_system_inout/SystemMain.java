...
public class SystemMain {
	...
	public static void main(String[] args) {
		// 콘솔에 텍스트 출력하기
		System.out.println("이미 알고 있는 것");  // 문자열 끝에 자동으로 줄바꿈
		System.out.print("이건 뭔가요?"); // 해당 문자열만을 출력
		System.out.printf("이건 또 뭐지?"); // 해당 문자열을 출력하지만, 문자열의 형식을 바꿀 수 있다.
		...
		// \(기능을 가지는 문자)
		System.out.println("제어문자를 사용하려면 \\를 써야 합니다.");
		System.out.println("소크라테스가 말하길.. \"너 자신을 알라\"");
		
		// 특수문자도 가능해요
		System.out.println("♡");
		
		// prinf 는 포맷 문자열과 함께 사용
		System.out.printf("%d명이 수업을 듣고 있습니다. \n", 21);
		System.out.printf("%d명이 수업을 %d시간 째 듣고 있습니다. \n", 21, 8);
		System.out.printf("%d명이 %s을 %d시간 째 듣고 있습니다. \n", 21, "수업", 8);
		
		int stuNum = 21;
		String strVar = "수업";
		int intVar = 8;
		System.out.println(stuNum + "명이 " + strVar + "을 " + intVar + "시간 째 듣고 있습니다.");
