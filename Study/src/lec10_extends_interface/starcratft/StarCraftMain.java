...
//		HighTemplar ht = starList.get(7);
		...
		// 부모 객체로 형변환 되었던 자식 객체는 다시 자식 객체로
		// 형변환이 가능하다.
...
//			}
		...
		// StarUnit을 상속받는 SiegeTank 클래스를 만들어 주세요
