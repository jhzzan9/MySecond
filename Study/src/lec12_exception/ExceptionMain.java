...
//			a.printStackTrace();
		...
		try {
			ExMethod.showName("12312");
		}catch(BizException b) {
			System.out.println("에러코드는: " + b.getErrCode());
...
//		}finally {
			...
			// 주로 try문에서 사용된 객체를 close 할 때 사용
